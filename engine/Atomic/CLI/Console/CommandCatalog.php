...
final class CommandCatalog
{
    ...
    private const COMMANDS = [
        ...
        'migrations/upgrade' => ['topic' => 'migrations', 'arguments' => '[--dry-run]', 'description' => 'Adopt legacy migration history', 'visible' => false],
        'migrations/publish' => ['topic' => 'migrations', 'arguments' => '<plugin-name>', 'description' => 'Publish plugin migrations', 'visible' => false],
