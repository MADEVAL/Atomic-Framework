...
$atomic->route('GET /telemetry/log-channels', 'Engine\Atomic\App\Telemetry->log_channels');
$atomic->route('GET /telemetry/log-stat', 'Engine\Atomic\App\Telemetry->log_stat');
