...
{
    public function test_set_home_path_marks_as_configured(): void
    {
        Redactor::set_home_path('/home/testuser');
        $this->assertTrue(Redactor::is_configured());
    ...
    public function test_init_from_hive_noop_when_both_empty(): void
    {
    ...
    public function test_redact_string_masks_home_path(): void
    {
        Redactor::set_home_path('/home/user');
        $result = Redactor::redact_string('File at /home/user/app/config.php');
        $this->assertSame('File at [HOME]/app/config.php', $result);
    }

    public function test_redact_string_masks_forward_and_backslash_variants(): void
    {
        Redactor::set_home_path('/home/user');
        $this->assertStringContainsString('[HOME]', Redactor::redact_string('/home/user/file.txt'));
        $this->assertStringContainsString('[HOME]', Redactor::redact_string('\\home\\user\\file.txt'));
    }
    ...
    public function test_redact_string_masks_authorization_header(): void
    {
        $input  = 'Authorization: Bearer abc123secret';
        $result = Redactor::redact_string($input);
        $this->assertStringNotContainsString('abc123secret', $result);
        $this->assertStringContainsString('[MASKED]', $result);
    }

    public function test_redact_string_masks_basic_auth(): void
    {
    ...
    public function test_redact_string_masks_url_credentials(): void
    {
    ...
    public function test_redact_string_masks_inline_key_value(): void
    {
    ...
    public function test_redact_string_masks_inline_token(): void
    {
    ...
    public function test_redact_string_masks_json_style_sensitive_pairs(): void
    {
    ...
    public function test_redact_string_leaves_harmless_string_alone(): void
    {
        Redactor::set_home_path('/unlikely/test/path/xyz');
        $input = 'Just a normal log message with no secrets';
        $this->assertSame($input, Redactor::redact_string($input));
    }

    public function test_redact_string(): void
    {
        $this->assertSame('hello', Redactor::redact('hello'));
    }

    public function test_redact_integer(): void
    {
        $this->assertSame(42, Redactor::redact(42));
    }

    public function test_redact_float(): void
    {
        $this->assertSame(3.14, Redactor::redact(3.14));
    }

    public function test_redact_bool(): void
    {
        $this->assertSame(true, Redactor::redact(true));
        $this->assertSame(false, Redactor::redact(false));
    }

    public function test_redact_null(): void
    {
        $this->assertNull(Redactor::redact(null));
    }

    public function test_redact_simple_array(): void
    {
    ...
    public function test_redact_array_masks_sensitive_keys(): void
    {
        $data = [
            'username' => 'admin',
            'password' => 'secret123',
    ...
    public function test_redact_nested_array_masks_deeply(): void
    {
        $data = [
            'config' => [
                'db' => [
    ...
    public function test_redact_array_sensitive_key_with_nested_array_traverses_structure(): void
    {
        $data = [
            'credentials' => [
                'username' => 'andri',
    ...
    public function test_redact_array_sensitive_key_with_nested_object_traverses_structure(): void
    {
        $inner         = new \stdClass();
    ...
    public function test_redact_array_truncation(): void
    {
        $big = array_fill(0, 1500, 'x');
        $result = Redactor::redact($big, 0, 6, 1000);
        $this->assertArrayHasKey('[[truncated]]', $result);
        $this->assertCount(1001, $result); // 1000 items + truncated marker
    }

    public function test_redact_numeric_keys_not_masked(): void
    {
    ...
    public function test_redact_max_depth_default(): void
    {
    ...
    public function test_redact_max_depth_custom(): void
    {
        $deep = ['a' => ['b' => ['c' => 'end']]];
        $result = Redactor::redact($deep, 0, 2, 1000);
        $this->assertSame('[[max_depth]]', $result['a']['b']);
    }

    public function test_redact_max_depth_one(): void
    {
        $data = ['nested' => ['value' => 1]];
        $result = Redactor::redact($data, 0, 1, 1000);
        $this->assertSame('[[max_depth]]', $result['nested']);
    }

    public function test_redact_stdclass(): void
    {
        $obj = new \stdClass();
        $obj->name = 'test';
    ...
    public function test_redact_stdclass_masks_sensitive_props(): void
    {
        $obj = new \stdClass();
        $obj->password = 's3cret';
        $obj->status   = 'active';
    ...
    public function test_redact_object_sensitive_prop_with_nested_array_traverses_structure(): void
    {
        $obj = new \stdClass();
        $obj->credentials = [
            'username' => 'andri',
    ...
    public function test_redact_object_sensitive_prop_with_nested_object_traverses_structure(): void
    {
        $inner          = new \stdClass();
    ...
    public function test_redact_object_sensitive_prop_scalar_is_masked(): void
    {
        $obj           = new \stdClass();
    ...
    public function test_redact_empty_object(): void
    {
        $obj = new \stdClass();
        $result = Redactor::redact($obj);
        $this->assertSame('stdClass', $result['__object__']);
    ...
    public function test_redact_resource(): void
    {
        $fh = fopen('php://memory', 'r');
        $result = Redactor::redact($fh);
        fclose($fh);
        $this->assertIsArray($result);
        $this->assertArrayHasKey('__resource__', $result);
    }

    public function test_redact_string_with_sensitive_values_inside_array(): void
    {
        $data = [
    ...
    public function test_redact_mixed_array_with_objects_and_scalars(): void
    {
        $obj = new \stdClass();
        $obj->id = 1;
        $data = [
