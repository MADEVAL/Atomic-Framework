...
defined('ATOMIC_APP_ROUTES') || define('ATOMIC_APP_ROUTES', ATOMIC_DIR . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'skeleton' . DIRECTORY_SEPARATOR . 'routes' . DIRECTORY_SEPARATOR);
defined('ATOMIC_CONFIG') || define('ATOMIC_CONFIG', ATOMIC_DIR . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'skeleton' . DIRECTORY_SEPARATOR . 'config' . DIRECTORY_SEPARATOR);

$monorepo_root = realpath(ATOMIC_DIR . '/../..');
$vendorPath = $monorepo_root . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR;
if (!is_dir($vendorPath)) {
    $vendorPath = ATOMIC_DIR . DIRECTORY_SEPARATOR . 'vendor' . DIRECTORY_SEPARATOR;
}
defined('ATOMIC_VENDOR') || define('ATOMIC_VENDOR', $vendorPath);
...
defined('ATOMIC_UPLOADS') || define('ATOMIC_UPLOADS', ATOMIC_DIR . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'skeleton' . DIRECTORY_SEPARATOR . 'public' . DIRECTORY_SEPARATOR . 'uploads' . DIRECTORY_SEPARATOR);
